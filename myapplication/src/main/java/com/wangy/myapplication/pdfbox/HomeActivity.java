//package com.wangy.myapplication.pdfbox;
//
...
//            font = PDType0Font.load(document, assetManager.open("simfang.ttf"));
//        }
//        catch (IOException e)
//        {
...
//            contentStream.showText("测试中文汉字是否保存成功");
...
//            String path =  "mnt/sdcard/11/Created.pdf";
//            document.save(path);
//            document.close();
